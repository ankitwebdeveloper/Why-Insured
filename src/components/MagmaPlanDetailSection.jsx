        ...
        <div className="flex items-start sm:items-center gap-2.5 sm:gap-3 flex-1 min-w-0">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-1 sm:gap-1.5 flex-wrap">
              ...
              {isRider && (
                <span className="text-[7px] sm:text-[9px] font-black uppercase px-1.5 py-0.5 rounded bg-[#ED1B24]/10 text-[#ED1B24] border border-[#ED1B24]/20 tracking-wide shrink-0">
                  Optional / Add-on
                </span>
              )}
            </div>
...
export default function MagmaPlanDetailSection({ plan, company, planId: planIdProp }) {
  ...
  const currentPlanId = resolveMagmaPlanId(planIdProp || plan?.id || urlPlanId);
  const planData = getMagmaPlanData(currentPlanId);
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 pt-2 sm:pt-4 space-y-8 sm:space-y-10 relative z-10">
          ...
          {planData.featuresSections?.map((sec, secIdx) => (
            <div key={sec.id || secIdx} className="space-y-3 sm:space-y-3.5">
              ...
              {/* Premium Deep Black / Red Accent Category Banner */}
              <motion.div
                initial={{ opacity: 0, y: 15 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                transition={{ duration: 0.4 }}
                className="w-full relative overflow-hidden rounded-xl sm:rounded-2xl bg-gradient-to-r from-[#000000] via-[#1A0002] to-[#000000] px-4 py-2.5 sm:px-5 sm:py-3 shadow-sm border border-[#ED1B24]/40"
              >
                ...
                <h2 className="text-xs sm:text-sm font-black uppercase tracking-wider text-white font-display flex items-center gap-2.5 relative z-10">
                  <span className="w-2 h-2 rounded-full bg-[#ED1B24] inline-block shadow-xs shrink-0" />
                  {sec.title}
                </h2>
              </motion.div>
      ...
      <div className="max-w-3xl mx-auto flex flex-col justify-start sm:justify-center items-stretch sm:min-h-[calc(100vh-220px)] py-1 sm:py-4 space-y-0">
        ...
        <div className="grid grid-cols-2 gap-2.5 sm:gap-5 w-full">
          ...
          >
            ...
            <h3 className="text-xs sm:text-base font-extrabold text-[#000000] group-hover:text-[#ED1B24] transition-colors duration-200 font-display leading-tight pr-1">
              REPORT CARD
            </h3>
        ...
        <div className="flex justify-center w-full mt-2.5 sm:mt-5">
          <button
            ...
            className="w-full sm:max-w-md bg-white rounded-xl sm:rounded-2xl border border-[#ED1B24]/35 p-2.5 sm:p-5 flex items-center justify-between text-left shadow-2xs hover:shadow-md hover:border-[#ED1B24] hover:-translate-y-0.5 transition-all duration-200 cursor-pointer group relative overflow-hidden active:scale-[0.98] select-none ring-1 ring-[#ED1B24]/10 hover:ring-[#ED1B24]/25"
          >
            {/* Bottom accent indicator bar */}
            <div className="absolute bottom-0 left-0 right-0 h-[2.5px] bg-[#ED1B24] transition-colors duration-200" />

            {/* Subtle ambient soft red background overlay */}
            <div className="absolute inset-0 bg-gradient-to-r from-[#FFF5F5]/90 via-white to-[#FFF5F5]/90 group-hover:from-[#FFEAEA] group-hover:to-[#FFEAEA] transition-colors duration-200 pointer-events-none" />

            {/* Text label with attention icon */}
            <div className="flex items-center gap-1.5 sm:gap-2.5 relative z-10 min-w-0 pr-1">
              <span className="text-[#ED1B24] text-xs sm:text-base font-black select-none shrink-0 group-hover:scale-110 transition-transform duration-200">
                ✦
              </span>
              <h3 className="text-xs sm:text-base font-black text-[#000000] group-hover:text-[#ED1B24] transition-colors duration-200 font-display tracking-wide uppercase leading-tight truncate">
                {planData.mustKnow?.buttonLabel || 'MUST KNOW DETAILS'}
              </h3>
            </div>

            {/* Right Arrow Bubble */}
            <div className="w-6 h-6 sm:w-8 sm:h-8 rounded-full bg-[#FFF5F5] border border-[#ED1B24]/25 flex items-center justify-center text-[#ED1B24] group-hover:bg-[#ED1B24] group-hover:text-white transition-all duration-200 shrink-0 relative z-10">
              <FiArrowRight className="text-xs sm:text-sm group-hover:translate-x-0.5 transition-transform duration-200" />
            </div>
          </button>
        </div>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6">
            ...
            >
              ...
              <button
                type="button"
                onClick={() => setActiveModal(null)}
                className="absolute top-3.5 right-3.5 sm:top-5 sm:right-5 w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-slate-100 flex items-center justify-center text-slate-500 hover:text-[#000000] hover:bg-slate-200 transition-colors cursor-pointer"
              >
