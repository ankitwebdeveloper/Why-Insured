                  ...
                  if (tab.isLink) {
                    return (
                      <Link
                        key={tab.id}
                        to={tab.url}
                        className="px-2.5 py-1 rounded-full text-[10px] sm:text-xs font-bold text-slate-600 hover:text-[#ED1B24] hover:bg-[#FFF5F5] border border-transparent whitespace-nowrap transition-colors select-none"
                      >
                        {tab.label}
                      </Link>
                    );
                  ...
                  return (
                    <button
                      ...
                      className={`px-2.5 py-1 rounded-full text-[10px] sm:text-xs font-bold whitespace-nowrap transition-all cursor-pointer select-none ${
                        isActive
                          ? 'bg-[#ED1B24] text-white shadow-2xs'
                          : 'text-slate-600 hover:text-[#ED1B24] hover:bg-[#FFF5F5]'
                      }`}
                    >
                      {tab.label}
                    </button>
