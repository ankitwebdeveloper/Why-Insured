  ...
  "care-plan": {
    ...
    additional: [
      ...
      },
      {
        ...
        summary: "Avail tax deductions on health insurance premiums paid under Section 80D of the Income Tax Act for family and senior parents."
      }
    ],
    riders: [
      {
    ...
    additional: [
      {
        id: "c3-1",
        title: "Emergency Road Ambulance",
        subtitle: "Emergency Road Ambulance Transit",
        summary: "Emergency surface road ambulance charges to the nearest hospital covered as per policy limits per hospitalisation."
      },
      {
        id: "c3-2",
      ...
      },
      {
        ...
        title: "Tax Savings under Sec 80D",
        subtitle: "Tax Deductions under Sec 80D",
        summary: "Avail annual income tax deductions on health insurance premiums paid under Section 80D."
      }
    ],
    riders: [
      {
...
const VideoButton = ({ featureTitle, onOpenVideo }) => {
  return (
    <button
      ...
      className="inline-flex items-center gap-0.5 sm:gap-1 px-1.5 sm:px-2 py-0.5 rounded-full bg-slate-100 hover:bg-[#1E3A8A] text-slate-600 hover:text-white border border-slate-200/80 text-[9px] sm:text-[10px] font-bold transition-all duration-150 active:scale-95 shrink-0"
        ...
        <div className="flex items-start sm:items-center gap-2 sm:gap-3 flex-1 min-w-0">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-1 sm:gap-1.5 flex-wrap">
              ...
              {isRider && (
                <span className="text-[7px] sm:text-[9px] font-black uppercase px-1.5 py-0.5 rounded bg-[#1E3A8A]/10 text-[#1E3A8A] tracking-wide shrink-0">
                  Rider
                </span>
              )}
            </div>
          ...
          >
            <div className="px-2.5 pb-2.5 sm:px-4.5 sm:pb-4.5 border-t border-slate-100/80 text-slate-600 space-y-2 sm:space-y-2.5">
              ...
              <div className="pt-2 sm:pt-3 flex flex-wrap items-center gap-1.5 sm:gap-2">
                {badgeText && (
                  <span className="inline-flex items-center gap-1 text-[8px] sm:text-[10px] font-black uppercase px-1.5 sm:px-2.5 py-0.5 rounded-md bg-[#FEFCE8] text-[#1E3A8A] border border-[#1E3A8A]/20 tracking-wider">
                    <span className="w-1 h-1 sm:w-1.5 sm:h-1.5 rounded-full bg-[#1E3A8A]" />
                    {badgeText}
                  </span>
                )}
                {subtitle && (
                  <span className="inline-flex items-center gap-1 text-[10px] sm:text-xs font-bold text-slate-700">
                    <FiCheck className="text-[#1E3A8A] text-[10px] sm:text-xs shrink-0" /> {subtitle}
                  </span>
                )}
              </div>
                    ...
                    {visualSteps.map((step, sIdx) => (
                      <React.Fragment key={sIdx}>
                        ...
                        {sIdx < visualSteps.length - 1 && (
                          <span className="text-[10px] sm:text-xs font-extrabold text-[#1E3A8A] px-0.5">
                            →
                          </span>
                        )}
                      </React.Fragment>
            ...
            >
              ...
              {activeModal === 'ratio' && (
                <div className="space-y-4 sm:space-y-6">
                  <div>
                    <span className="text-[9px] sm:text-[10px] font-extrabold uppercase tracking-widest text-[#1E3A8A] block">
                  ...
                  <div className="space-y-2 sm:space-y-3">
                    <div className="bg-[#FEFCE8] p-3 sm:p-4 rounded-xl sm:rounded-2xl border border-[#1E3A8A]/20 flex justify-between items-center">
                      <div>
                      ...
                      <span className="text-base sm:text-lg font-black text-[#1E3A8A]">{settlementRatio}</span>
                    </div>
                ...
                <div className="space-y-4 sm:space-y-6">
                  ...
                  <div className="space-y-2 sm:space-y-3">
                    <div className="p-3 sm:p-4 bg-slate-50 rounded-xl sm:rounded-2xl border border-slate-100 space-y-0.5 sm:space-y-1">
                      <span className="text-[9px] sm:text-[10px] font-extrabold uppercase tracking-widest text-[#1E3A8A]">
                    ...
                    <div className="p-3 sm:p-4 bg-slate-50 rounded-xl sm:rounded-2xl border border-slate-100 space-y-0.5 sm:space-y-1">
                      ...
                      <p className="text-xs font-bold text-[#0F172A]">
                        21,000+ Cashless Hospitals across India
                      </p>
                    </div>
