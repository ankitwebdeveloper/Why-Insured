...
import { getCarePlanData, resolveCarePlanId } from '../data/careHealthPlansData';
...
export default function CareHealthPlanDetailSection({ plan, company, planId: planIdProp }) {
  ...
  // Resolve to canonical Care Health plan ID — each plan gets independent data
  const currentPlanId = resolveCarePlanId(planIdProp || plan?.id || urlPlanId);
  const planData = getCarePlanData(currentPlanId);
  ...
  // =========================================================================
  // MAIN CARE HEALTH PLAN DETAIL PAGE (SINGLE VIEWPORT — APPROVED HDFC UX STRUCTURE)
  // =========================================================================
  return (
            ...
            >
                ...
                <div className="space-y-4 sm:space-y-5">
                  <div className="pr-8">
                    ...
                    <p className="text-xs text-[#003366] font-medium mt-0.5">
                      Care Health Performance
                    </p>
                  </div>

                  {/* 3 EQUAL ACCORDION BOXES — CARE HEALTH NAVY BORDERS & ACCENTS */}
                  <div className="space-y-2.5 sm:space-y-3">
                    {/* Box 1: CSR */}
                    <div className="rounded-xl sm:rounded-2xl border border-[#003366]/35 bg-white overflow-hidden shadow-2xs hover:border-[#003366]/70 transition-colors">
                      <button
                        type="button"
                      ...
                      >
                        <div className="flex items-center justify-between flex-1 min-w-0 pr-2 sm:pr-3 gap-2">
                          <span className="text-xs sm:text-sm font-semibold tracking-wider uppercase text-slate-900 group-hover:text-[#003366] transition-colors font-display shrink-0">
                            CSR
                          </span>
                        ...
                        <div className="w-6 h-6 sm:w-7 sm:h-7 rounded-full bg-slate-50 border border-slate-100 flex items-center justify-center group-hover:bg-[#F0F8FF]/60 group-hover:border-[#003366]/25 transition-all duration-300 shrink-0 select-none">
                          <FiChevronDown className={`text-xs sm:text-sm transition-transform duration-300 transform ${expandedReportCard.csr ? 'rotate-180 text-[#003366]' : 'text-slate-400 group-hover:text-slate-600'}`} />
                        </div>
                      </button>
                        ...
                        {expandedReportCard.csr && (
                          ...
                          >
                            <div className="p-3.5 sm:p-4 border-t border-slate-100 bg-slate-50/30 space-y-3">
                              <div>
                                <span className="text-[11px] sm:text-xs font-semibold text-[#003366] tracking-wide block font-display">
                    ...
                    <div className="rounded-xl sm:rounded-2xl border border-[#003366]/35 bg-white overflow-hidden shadow-2xs hover:border-[#003366]/70 transition-colors">
                      ...
                      >
                        ...
                        <div className="w-6 h-6 sm:w-7 sm:h-7 rounded-full bg-slate-50 border border-slate-100 flex items-center justify-center group-hover:bg-[#F0F8FF]/60 group-hover:border-[#003366]/25 transition-all duration-300 shrink-0 select-none">
                          <FiChevronDown className={`text-xs sm:text-sm transition-transform duration-300 transform ${expandedReportCard.icr ? 'rotate-180 text-[#003366]' : 'text-slate-400 group-hover:text-slate-600'}`} />
                        </div>
                      </button>
                    ...
                    <div className="rounded-xl sm:rounded-2xl border border-[#003366]/35 bg-white overflow-hidden shadow-2xs hover:border-[#003366]/70 transition-colors">
                      ...
                      >
                        <div className="flex items-center justify-between flex-1 min-w-0 pr-2 sm:pr-3 gap-2">
                          <span className="text-xs sm:text-sm font-semibold tracking-wider uppercase text-slate-900 group-hover:text-[#003366] transition-colors font-display truncate">
                            COMPLAINT VOLUME
                          </span>
                        ...
                        <div className="w-6 h-6 sm:w-7 sm:h-7 rounded-full bg-slate-50 border border-slate-100 flex items-center justify-center group-hover:bg-[#F0F8FF]/60 group-hover:border-[#003366]/25 transition-all duration-300 shrink-0 select-none">
                          <FiChevronDown className={`text-xs sm:text-sm transition-transform duration-300 transform ${expandedReportCard.complaint ? 'rotate-180 text-[#003366]' : 'text-slate-400 group-hover:text-slate-600'}`} />
                        </div>
                      </button>
              ...
              {activeModal === 'fundamental' && (
                <div className="space-y-4 sm:space-y-5">
                  ...
                  {/* 6 EQUAL ACCORDION BOXES — CARE HEALTH THEME */}
                  <div className="space-y-2.5 sm:space-y-3">
                    ...
                    <div className="rounded-xl sm:rounded-2xl border border-[#003366]/35 bg-white overflow-hidden shadow-2xs hover:border-[#003366]/70 transition-colors">
                      ...
                      >
                        ...
                        <div className="w-6 h-6 sm:w-7 sm:h-7 rounded-full bg-slate-50 border border-slate-100 flex items-center justify-center group-hover:bg-[#F0F8FF]/60 group-hover:border-[#003366]/25 transition-all duration-300 shrink-0 select-none">
                          <FiChevronDown className={`text-xs sm:text-sm transition-transform duration-300 transform ${expandedCompanyStrength.ownership ? 'rotate-180 text-[#003366]' : 'text-slate-400 group-hover:text-slate-600'}`} />
                        </div>
                      </button>
                    ...
                    <div className="rounded-xl sm:rounded-2xl border border-[#003366]/35 bg-white overflow-hidden shadow-2xs hover:border-[#003366]/70 transition-colors">
                      ...
                      >
                        ...
                        <div className="w-6 h-6 sm:w-7 sm:h-7 rounded-full bg-slate-50 border border-slate-100 flex items-center justify-center group-hover:bg-[#F0F8FF]/60 group-hover:border-[#003366]/25 transition-all duration-300 shrink-0 select-none">
                          <FiChevronDown className={`text-xs sm:text-sm transition-transform duration-300 transform ${expandedCompanyStrength.creditRating ? 'rotate-180 text-[#003366]' : 'text-slate-400 group-hover:text-slate-600'}`} />
                        </div>
                      </button>
                    ...
                    <div className="rounded-xl sm:rounded-2xl border border-[#003366]/35 bg-white overflow-hidden shadow-2xs hover:border-[#003366]/70 transition-colors">
                      ...
                      >
                        ...
                        <div className="w-6 h-6 sm:w-7 sm:h-7 rounded-full bg-slate-50 border border-slate-100 flex items-center justify-center group-hover:bg-[#F0F8FF]/60 group-hover:border-[#003366]/25 transition-all duration-300 shrink-0 select-none">
                          <FiChevronDown className={`text-xs sm:text-sm transition-transform duration-300 transform ${expandedCompanyStrength.capitalStrength ? 'rotate-180 text-[#003366]' : 'text-slate-400 group-hover:text-slate-600'}`} />
                        </div>
                      </button>
                    ...
                    <div className="rounded-xl sm:rounded-2xl border border-[#003366]/35 bg-white overflow-hidden shadow-2xs hover:border-[#003366]/70 transition-colors">
                      ...
                      >
                        ...
                        <div className="w-6 h-6 sm:w-7 sm:h-7 rounded-full bg-slate-50 border border-slate-100 flex items-center justify-center group-hover:bg-[#F0F8FF]/60 group-hover:border-[#003366]/25 transition-all duration-300 shrink-0 select-none">
                          <FiChevronDown className={`text-xs sm:text-sm transition-transform duration-300 transform ${expandedCompanyStrength.financialBase ? 'rotate-180 text-[#003366]' : 'text-slate-400 group-hover:text-slate-600'}`} />
                        </div>
                      </button>
                    ...
                    <div className="rounded-xl sm:rounded-2xl border border-[#003366]/35 bg-white overflow-hidden shadow-2xs hover:border-[#003366]/70 transition-colors">
                      ...
                      >
                        ...
                        <div className="w-6 h-6 sm:w-7 sm:h-7 rounded-full bg-slate-50 border border-slate-100 flex items-center justify-center group-hover:bg-[#F0F8FF]/60 group-hover:border-[#003366]/25 transition-all duration-300 shrink-0 select-none">
                          <FiChevronDown className={`text-xs sm:text-sm transition-transform duration-300 transform ${expandedCompanyStrength.reinsurance ? 'rotate-180 text-[#003366]' : 'text-slate-400 group-hover:text-slate-600'}`} />
                        </div>
                      </button>
                    ...
                    <div className="rounded-xl sm:rounded-2xl border border-[#003366]/35 bg-white overflow-hidden shadow-2xs hover:border-[#003366]/70 transition-colors">
                      ...
                      >
                        ...
                        <div className="w-6 h-6 sm:w-7 sm:h-7 rounded-full bg-slate-50 border border-slate-100 flex items-center justify-center group-hover:bg-[#F0F8FF]/60 group-hover:border-[#003366]/25 transition-all duration-300 shrink-0 select-none">
                          <FiChevronDown className={`text-xs sm:text-sm transition-transform duration-300 transform ${expandedCompanyStrength.marketPosition ? 'rotate-180 text-[#003366]' : 'text-slate-400 group-hover:text-slate-600'}`} />
                        </div>
                      </button>
              ...
              {activeModal === 'limitations' && (
                <div className="space-y-4 sm:space-y-5">
                  <div className="pr-8">
                    <span className="text-[10px] sm:text-[11px] font-bold uppercase tracking-widest text-[#003366] block font-display">
                  ...
                  <div className="space-y-2.5 sm:space-y-3">
                    {planData.limitationsWaitingPeriods?.items.map((item) => {
                      ...
                      return (
                        <div
                          key={item.id}
                          className="rounded-xl sm:rounded-2xl border border-[#003366]/35 bg-white overflow-hidden shadow-2xs hover:border-[#003366]/70 transition-colors"
                        >
                          <button
                            type="button"
                            ...
                            className="w-full p-3.5 sm:p-4 bg-white hover:bg-slate-50/50 flex items-center justify-between text-left transition-colors cursor-pointer select-none group gap-2"
                          >
                            <span className="text-xs sm:text-sm font-semibold tracking-wider uppercase text-slate-900 group-hover:text-[#003366] transition-colors font-display pr-2">
                              {item.title}
                            </span>
                            <div className="w-6 h-6 sm:w-7 sm:h-7 rounded-full bg-slate-50 border border-slate-100 flex items-center justify-center text-slate-400 group-hover:text-[#003366] group-hover:bg-[#F0F8FF] group-hover:border-[#003366]/25 transition-all duration-200 shrink-0 select-none">
                              <FiArrowRight
                                className={`text-xs sm:text-sm transition-transform duration-200 ${
                                  isItemExpanded ? 'rotate-90 text-[#003366]' : 'group-hover:translate-x-0.5'
                                }`}
                              />
                            </div>
                          </button>
                            ...
                            {isItemExpanded && (
                              ...
                              >
                                <div className="p-3.5 sm:p-4 border-t border-slate-100 bg-slate-50/30 space-y-3">
                                  ...
                                  {item.diseaseList && (
                                    <div className="p-3 sm:p-4 rounded-xl bg-[#F0F8FF]/60 border border-[#003366]/15 space-y-2">
                                      <span className="text-[10px] sm:text-xs font-black uppercase tracking-wider text-[#003366] block font-display">
                                  ...
                                  {(item.policyRef || item.durationTag) && (
                                    <div className={`pt-2 border-t ${isPermanent ? 'border-rose-200/60' : 'border-slate-200/60'} flex items-center justify-between text-[11px] sm:text-xs text-slate-400 font-semibold`}>
                                      ...
                                      {item.durationTag && (
                                        <span className={isPermanent ? 'text-rose-600 font-bold' : 'text-[#003366] font-bold'}>
                                          {item.durationTag}
                                        </span>
                                      )}
                                    </div>
